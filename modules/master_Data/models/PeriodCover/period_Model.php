...
class period_Model extends CI_Model {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->load->database();
        $this->table = 'tblmd_PeriodCover';
        // Set orderable column fields
        $this->column_select = array("PeriodNumber", "period_code", "Period_from", "Period_to", "Date_From", "Period_from", "Date_To", "Status");
        $this->column_order = array("PeriodNumber", "period_code", "Period_from", "Period_to", "Date_From", "Period_from", "Date_To", "Status");
        // Set searchable column fields
        $this->column_search = array("PeriodNumber");
        // Set default order
        $this->order = array("PeriodNumber" => 'asc');
        $this->key = 'PeriodNumber';
    }
    ...
    public function getIndexCode() {
        $this->db->select("MAX(PeriodNumber) + 1 as code");
        $this->db->from("tblmd_PeriodCover");
        $query = $this->db->get();
        return $query->result();
    }
