...
class merch_Model extends CI_Model {
    ...
    function getStore() {
        $query = $this->db->query('SELECT id,accManager ,storeName FROM tblmd_store where status = 1 and (accManager != 0 or accManager != NULL)');
        return $query->result();
    }
    ...
    public function countAll() {
        ...
        $this->db->from($this->table);
        $array = array('tbl_users.admin' => 0, 'tbl_users.acmanager' => 0);
        $this->db->where($array);
