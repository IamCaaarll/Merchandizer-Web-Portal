...
class holiday_Model extends CI_Model {
    ...
    public function __construct() {
        ...
        parent::__construct();
        $this->load->database();
        $this->table = 'tblmd_holiday';
        // Set orderable column fields
        $this->column_select = array("id", "holiday_Code", "description", "holiday_Type", "holiday_Date");
        $this->column_order = array("id", "holiday_Code", "description", "holiday_Type", "holiday_Date");
        // Set searchable column fields
        $this->column_search = array("holiday_Code", "holiday_Type", "description");
        // Set default order
