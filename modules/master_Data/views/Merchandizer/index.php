...
<div class="content-wrapper" >
    <div class="content-header row">
            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Merchandizer
                        </li>
                    </ol>
                </div>
            </div>
            <h3 class="content-header-title mb-0">Merchandizer List</h3>
        </div>
        <div class="content-header-right col-md-6 col-12">
            <div class="btn-group float-md-right" role="group">   
                <button type="button" class="btn btn-info btn-min-width box-shadow-1 mr-1 mb-1" id ="addmerch_Modal" data-toggle="modal" data-target="#merchModal"><i class="ft-plus icon-left"></i> Add Merchandizer</button>
            </div>
        </div>
        ...
        <!-- Modal -->
        <div class="modal animated pulse text-left" id="merchModal" tabindex="-1" role="dialog" aria-labelledby="merchModal" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger white">
                        <h3 class="modal-title white" id="merchModalTitle"><i class="ft-edit"></i> Merchandizer Entry</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body merch-body"style="padding-right: 15px;" >
                        <form class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section"><i class="fa fa-eye"></i> About Merchandizer</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                                            <label for="contPer">Agency</label>
                                            <fieldset  id="dropParent">
                                                <select class="select2-placeholder form-control required urequired" style="width:100%" id="cbo_Agency" name="cbo_Agency">
                                                    <option></option>
                                                    <?php foreach ($agencyData as $row): ?>
                                                        <option value="<?php echo $row->id; ?>"><?php echo $row->Agency; ?></option>
                                                    <?php endforeach; ?>
                                                </select>       
                                            </fieldset>
                                        </fieldset>
                                    ...
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                                            ...
                                            <fieldset  id="dropParent">
                                                <select class="select2-placeholder form-control required urequired" style="width:100%" id="cbo_Store" name="cbo_Store">
                                                    <option></option>
                                                    <?php foreach ($storeData as $row): ?>
                                                        <option value="<?php echo $row->id; ?>" data-accManager="<?php echo $row->accManager; ?>">
                                ...
                                <h4 class="form-section"><i class="ft-user"></i> Merchandizer Account</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" id="saveMerch" disabled>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show" id="data" class="collapse">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table id="merchTable" class="table table-striped table-bordered select-multi">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>User ID</th>
