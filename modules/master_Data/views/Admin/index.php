...
<div class="content-wrapper" >
    <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
            ...
            <h3 class="content-header-title mb-0">Admin List</h3>
        </div>
        <div class="content-header-right col-md-6 col-12">
            <div class="btn-group float-md-right" role="group">   
                <button type="button" class="btn btn-info btn-min-width box-shadow-1 mr-1 mb-1" id ="addadmin_Modal" data-toggle="modal" data-target="#adminModal"><i class="ft-plus icon-left"></i> Add Admin</button>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" id="resetMerch" disabled>
        ...
        <!-- Modal -->
        <div class="modal animated pulse text-left" id="adminModal" tabindex="-1" role="dialog" aria-labelledby="merchModal" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger white">
                        <h3 class="modal-title white" id="adminModalTitle"><i class="ft-edit"></i> Admin Entry</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body merch-body">
                        <form class="form form-horizontal">
                            <div class="form-body">
                                <h4 class="form-section"><i class="fa fa-eye"></i> About Admin</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" id="eaddress" class="form-control upperCase required urequired" placeholder="Enter Email Address" name="eaddress">
                                            </fieldset>
                                        </fieldset>
                                    </div>
                                </div>
                                <h4 class="form-section"><i class="ft-user"></i> Admin Account</h4>
                                <div class="row">
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <fieldset class="form-group">
                                            <label for="userid">User Access</label>
                                            <fieldset>
                                                <button type="button" class="btn btn-outline-danger" id="userAccess">
                                                    <i class="ft-save"></i> Add User Access
                                                </button>
                                            </fieldset> 
                                        </fieldset>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" id="saveAdmin" >
        ...
        <!-- Modal -->
        <div class="modal animated pulse text-left" id="accessModal" tabindex="-1" role="dialog" aria-labelledby="accessModal" aria-hidden="true">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header bg-danger white">
                        <h3 class="modal-title white" id="accessModalTitle"><i class="ft-edit"></i> User Access Entry</h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <select multiple="multiple" size="10" class="duallistbox-custom-height" id="access" name="cbo_manager">
                            <option></option>

                        </select>  
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-danger" id="saveAccess">
                            <i class="ft-save"></i> Save
                        </button>
                    </div>
                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collapse show" id="data" class="collapse">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table id="adminTable" class="table table-striped table-bordered select-multi">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>User ID</th>
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/robust/app-assets/vendors/css/forms/listbox/bootstrap-duallistbox.min.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/robust/app-assets/css/plugins/forms/dual-listbox.min.css">
<script src="<?php echo base_url(); ?>assets/robust/app-assets/vendors/js/forms/listbox/jquery.bootstrap-duallistbox.min.js"></script>

<script src="<?php echo base_url(); ?>assets/robust/app-assets/js/scripts/forms/listbox/form-duallistbox.min.js"></script>
