            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Summary
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show" id="data" class="collapse" style="zoom:90%">
                        <div class="card-body card-dashboard">
                                    ...
                                    <fieldset class="form-group">
                                        ...
                                        <fieldset  id="dropParent">
                                            <select class="select2-placeholder form-control required urequired" style="width:100%" id="cbo_filter" name="cbo_filter">
                                                ...
                                                <option value="mornIn">Morning In</option>
                                                <option value="mornOut">Morning Out</option>
                                                <option value="aftrIn">Afternoon In</option>
                                                <option value="aftrOut">Afternoon Out</option>
                                            </select>       
                                        </fieldset>
                                    </fieldset>
                                </div>
                            ...
                            <div class="row">
                                <table id="summaryTable" class="table table-striped table-bordered select-multi">
                                    <thead>
                                        <tr>
                                            <th>Name</th>
